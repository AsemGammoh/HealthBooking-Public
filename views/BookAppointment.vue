  ...
  <div>
    ...
    <div class="d-flex justify-content-center align-items-center" style="min-height: 80vh;">
      <div class="card shadow p-5" style="width: 100%; max-width: 700px;">
        ...
        <p v-if="slots.length === 0" class="text-center text-muted mt-3">
  ...
  methods: {
    ...
    async fetchSlots() {
      try {
        ...
        const response = await fetch(`https://2r4l7cheo4.execute-api.eu-north-1.amazonaws.com/prod/slots`);
    ...
    async submitAppointment() {
      ...
      try {
        ...
        const response = await fetch(`https://2r4l7cheo4.execute-api.eu-north-1.amazonaws.com/prod/appointments`, {
          method: "POST",
          headers: {
